...
final class DigitColumnDetection {
    ...
    typealias WordsBytypes = (many: [SimpleWord], other: [SimpleWord])
    ...
    private func getTypesWithSplitedArrays(_ wordRectangles: [SimpleWord]) -> (types: [SymbolsCount], WordsBytypes) {
