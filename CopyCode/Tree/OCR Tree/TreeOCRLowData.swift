...
private let nnLowSubTree = OCR.n(.c,
                                 OCR.n(.lC,
                                       OCR.n(.yRange(x: 1, y: 7...9, op: .and),
                                             ...
                                             OCR.n(.plus_e,
                                                   .r("+"),
                                                   OCR.n(.yRange(x: 0.5, y: 9...10, op: .or),
                                                         e_aTree,
                                                         .r("<")))),
                                       OCR.n(.xy(x:0.1, y: 0.25),

                                             OCR.n(.vLine(l: 5...9, x: 3...5, op: .and, mainOp: .or),
                                                   .r("*"),
                                             ...
                                             OCR.n(.bL,
                                                   OCR.n(.bC,
                                                         ...
                                                         .r("x")),
                                                   OCR.n(.xRange(x: 4...6, y: 0.05, op: .and),
                                                         .r("a"),
                                                         OCR.n(.x_asterix,
                                                               OCR.n(.bC, .r("i"), .r("x")),
                                                               .r("*")))))),
                                                   ...
                                                   OCR.n(.xy(x:0.5, y: 0.4),
                                                         OCR.n(.xy(x: 0.05, y: 0.5),
                                                               OCR.n(.xy(x: 0.5, y: 0.05),
                                                                     ...
                                                                     .r("<")),
                                                               .r("r")),
                                                         OCR.n(.xRange(x: 5...8, y: 0.5, op: .allFalse),

                                                               OCR.n(.yRange(x: 0.3, y: 0...1, op: .or), .r("c"), .r("<")),
                                                               .r("v")))))))
                                                    ...
                                                    OCR.n(.yRange(x: 0.9, y: 6...7, op: .or),
                                                          OCR.n(.yRange(x: 0.95, y: 4...6, op: .and),
                                                                ...
                                                                OCR.n(.yRange(x: 0.8, y: 0...5, op: .or),
                                                                      .r("s"),
                                                                      .r("i"))),
                                                          OCR.n(.yRange(x: 0.5, y: (-5)...(-3), op: .or), .r("i"), .r("r")))),
                                              n_wSubTree)),
...
private let nppnLowSubTree = OCR.n(.xy(x: 0, y: 1),
                                   OCR.n(.xy(x: 0.95, y: 0.6),
                                         OCR.n(.yRange(x: 0.05, y: 6...8, op: .and),
                                               OCR.n(.xRange(x: 9...10, y: 0.5, op: .or),
                                               .r("m"),
                                               .r("c")),
                                               OCR.n(.m_a,
                                                     .r("m"),
                                   ...
                                   OCR.n(.xRange(x: 5...9, y: 0.5, op: .allFalse),
                                         OCR.n(.yRange(x: 0.5, y: 4...6, op: .allFalse),
                                               .r("c"),
                                               .r("e")),
                                         OCR.n(.xy(x: 0.5, y: 1),
