...
private let pppSubTree = OCR.n(.ratio(>, 7.5),
                               ...
                               OCR.n(.rC,
                                     //improve
                                OCR.n(.vLine(l: 1...9, x: 9...10, op: .and, mainOp: .or), .r("]"), .r(")")),
                                OCR.n(.lCr,
                                      //improve
                                    OCR.n(.vLine(l: 1...9, x: 0...1, op: .and, mainOp: .or), .r("["), .r("(")),
                                    OCR.n(.bL, .r("I"), .r("1")))))
...
private let npppSubTree = OCR.n(.bL,
                                ...
                                OCR.n(.G_C,
                                      OCR.n(.tCr,
                                            ...
                                            .r("d")),
                                      OCR.n(.ratio(>, 2),
                                            OCR.n(.xyp(x: 0.05, y: 0.5, p: 90), .r("{"), .r("t")),
...
private let n7fWDollarSlashTree = OCR.n(.n7_W,
                                        ...
                                        OCR.n(.ratio(>, 1.4),
                                              ...
                                              OCR.n(.xRange(x:7...10, y: 0.3, op: .or), .r("W"), .r("$")) ))
private let braceOrRoundL = OCR.n(.yRange(x: 0.1, y: 3...6, op: .and), .r("("), .r("{"))
